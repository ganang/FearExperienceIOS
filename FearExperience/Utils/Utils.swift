...
struct Utils {
    ...
    static func createAlert(controller: UIViewController, title: String = "Not Available", message: String = "This video is still in development", style: UIAlertController.Style){
